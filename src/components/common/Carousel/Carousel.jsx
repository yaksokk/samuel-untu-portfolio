                ...
                <div className="overflow-hidden">
                    ...
                    >
                        {items.map((item, i) => (
                            <div
                                key={i}
                                className="shrink-0 rounded-2xl overflow-hidden bg-surface dark:bg-surface-dark border border-border dark:border-border-dark hover:border-primary dark:hover:border-primary-dark transition-all duration-300 group cursor-zoom-in"
                                style={{ width: itemWidth }}
                                onClick={() => setLightbox({ src: item.img ?? item, alt: item.name ?? `photo-${i}` })}
                            >
